...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="b1" style="table-layout:fixed;word-wrap:break-word;">
    <tbody><tr>
        ...
        <td width="21%" class="ttd"><img src="./Public/images/zgss.jpg" width="159" height="240"></td>
    </tr>
    <form name="form1" onSubmit="return Check(this)" method="post" action="">
        ...
        <tr>
            <td colspan="2" class="new">
                请输入三个简体汉字抽签占卜：
                <input name="name1" type="text" id="name1" size="20" onKeyUp="value=value.replace(/[^\u4E00-\u9FA5]/g,'')" maxLength="3">（多输入只取前三个） <input type="submit" name="Submit1" value="提交" style="cursor:hand;"></form></td>
    </tr>
    <?php if($str1 != '' and $str2 != '' and $str3 != ''): ?><tr bgcolor="#EFF8FE">
        <td class="new" colspan="2" valign="middle">
            <br>您输入的三个汉字为：<font color=blue><?php echo ($str1); ?>&nbsp;<?php echo ($str2); ?>&nbsp;<?php echo ($str3); ?></font><br><br>
            <font color=cc6600>〖诗曰〗：</font><?php echo ($zhugetitle); ?><br><br>
            <font color=cc6600>〖签释〗：</font><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($zhugecontent); ?><br><br>
        </td>
    </tr><?php endif; ?>
    </tbody>
</table>
