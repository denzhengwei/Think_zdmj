...
<tbody>
<tr>
    <td width="100%" class="ttop" height=20px align="center"><?php echo ($title); ?> &nbsp;&nbsp;&nbsp;<a href="<?php echo U('home/sxxzxx/index');?>"  > 返回生肖星座主页</a></td>
</tr>
<tr>
    <td class=new style="PADDING-BOTTOM: 1px" vAlign=top><?php echo ($content); ?></td>
</tr>
</tbody>
</table>
</div>
