...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="b1" style="table-layout:fixed;word-wrap:break-word;">
    <tbody><tr>
        ...
        <td width="21%" class="ttd"><img src="./Public/images/qqpd.jpg" width="120" height="90"></td>
    </tr>
    ...
    <?php if(isset($_REQUEST['act']) && $_REQUEST['act']=='ok'): ?><tr >
        <td class="new" colspan="2" valign="middle">
            <br>双方QQ：<font color=blue><?php echo ($strname1); ?>&nbsp;<?php echo ($strname2); ?> </font><br><br>
